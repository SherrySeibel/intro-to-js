...
putAnXBtn.onclick = function(){
 	...
 	// get a reference to the box
         ...
         *   */
          ...
          var yPosition = Math.floor(Math.random() * (10, height)); // should generate a value between 0 and the height
          var xPosition = Math.floor(Math.random() * (10, width)); //should generate a value between 0 and the width
